...
export function isRepository(value: unknown): value is Repository {
  return svt.isInterface<Repository>(value, {
    id: svt.isNumber,
    name: svt.isString,
...
export function validateRepository(value: unknown): svt.ValidationResult<Repository> {
  return svt.validate<Repository>(value, {
    id: svt.validateNumber,
...
export function isAuthor(value: unknown): value is Author {
  return svt.isInterface<Author>(value, {
    name: svt.isString,
    email: svt.isString,
    username: svt.isString,
  });
}

export function validateAuthor(value: unknown): svt.ValidationResult<Author> {
  return svt.validate<Author>(value, {
    name: svt.validateString,
    email: svt.validateString,
    username: svt.validateString,
  });
}
...
export function isLabel(value: unknown): value is Label {
  return svt.isInterface<Label>(value, {
    id: svt.isNumber,
    url: svt.isString,
    name: svt.isString,
    color: svt.isString,
    default: svt.isBoolean,
    description: svt.isString,
  });
}

export function validateLabel(value: unknown): svt.ValidationResult<Label> {
  return svt.validate<Label>(value, {
    id: svt.validateNumber,
    url: svt.validateString,
    name: svt.validateString,
    color: svt.validateString,
    default: svt.validateBoolean,
    description: svt.validateString,
  });
}
...
export function isIssue(value: unknown): value is Issue {
  return svt.isInterface<Issue>(value, {
    id: svt.isNumber,
    url: svt.isString,
    html_url: svt.isString,
    ...
    updated_at: svt.isString,
    closed_at: svt.optional(svt.isString),
    author_association: svt.isString,
    body: svt.isString,
  });
}

export function validateIssue(value: unknown): svt.ValidationResult<Issue> {
  return svt.validate<Issue>(value, {
    id: svt.validateNumber,
    url: svt.validateString,
    html_url: svt.validateString,
    ...
    updated_at: svt.validateString,
    closed_at: svt.validateOptional(svt.validateString),
    author_association: svt.validateString,
...
export function isCommit(value: unknown): value is Commit {
  return svt.isInterface<Commit>(value, {
    id: svt.isString,
    tree_id: svt.isString,
    distinct: svt.isBoolean,
    message: svt.isString,
    timestamp: svt.isString,
    url: svt.isString,
    author: isAuthor,
    committer: isAuthor,
    added: svt.arrayOf(svt.isString),
    removed: svt.arrayOf(svt.isString),
    modified: svt.arrayOf(svt.isString),
  });
}

export function validateCommit(value: unknown): svt.ValidationResult<Commit> {
  return svt.validate<Commit>(value, {
    id: svt.validateString,
    tree_id: svt.validateString,
    distinct: svt.validateBoolean,
    message: svt.validateString,
    timestamp: svt.validateString,
    url: svt.validateString,
    author: validateAuthor,
    committer: validateAuthor,
    added: svt.validateArray(svt.validateString),
    removed: svt.validateArray(svt.validateString),
    modified: svt.validateArray(svt.validateString),
  });
}
...
export function isPushData(value: unknown): value is PushData {
  return svt.isInterface<PushData>(value, {
    ...
    compare: svt.isString,
    commits: svt.arrayOf(isCommit),
    head_commit: isCommit,
  });
}

export function validatePushData(value: unknown): svt.ValidationResult<PushData> {
  return svt.validate<PushData>(value, {
    repository: validateRepository,
    ref: svt.validateString,
    ...
    compare: svt.validateString,
    commits: svt.validateArray(validateCommit),
    head_commit: validateCommit,
  });
}
